...
const ListProducts = ({
  ...
  const dummyImageURL =
    "https://optinmonster.com/wp-content/uploads/2019/01/cart-abandonment-statistics.png";
  ...
  return (
    <div className="bg-canvas p-5">
      {editing ? (
        <form
          className="shadow bg-light p-5 mx-auto mb-5 rounded-1"
          style={{ maxWidth: "40rem" }}
          onSubmit={(e) => handleUpdateProduct(e, editItemId, userInfo)}
        >
          ...
          <div className="row px-2">
            <div className="col-md-8 col-sm-12 p-1">
              ...
              <div className="mb-1 d-flex">
                ...
                <input
                  ...
                  className="form-control rounded-1"
                  name="stock"
                  placeholder="Enter number of products in the stock"
                  value={stock === 0 ? "" : stock}
              ...
              <div className="mb-1 d-flex">
                <select
                  class="form-select rounded-1 me-1"
            ...
            <div className="col-md-4 col-sm-12 py-1 px-0">
              <img
                class="mb-1 rounded-1"
                src={BASE_URL + `/api/v1/products/image/${imageURL}`}
                alt=""
                style={{ width: "11.2rem", height: "203px" }}
              />
            </div>
          </div>
          <button
        ...
        <form
          className="shadow bg-light p-5 mx-auto mb-5 rounded-1"
          style={{ maxWidth: "40rem" }}
          onSubmit={(e) => handleAddProduct(e, userInfo)}
        >
      ...
      <div className="row mx-0 d-flex justify-content-center">
        <div className="mb-1 d-flex justify-content-end">
          <input
            ...
            className="form-control rounded-1 border p-2 me-3"
            style={{ width: "15rem" }}
        ...
        {loading ? (
          ...
          <>
            {products.map((product, index) => (
              <div
                className="row rounded-1 shadow bg-light p-0 m-1"
                style={{ width: "38rem" }}
              >
                ...
                <div className="col-md-8 col-sm-12 p-3">
                  ...
                  <b className="me-2">ECPD{product.productId}, </b>
                  <label>Price: </label>
                  <b className="me-2">₹ {product.price},</b>
                  <label>In Stock: </label>
                  <b className="me-2">{product.stock}</b>
                  <hr />
                  <div className="d-flex justify-content-end">
                    <button
                      ...
                      className="custom-btn1 px-4 me-1"
                    >
                      Edit
                    </button>
