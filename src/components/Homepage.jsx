            ...
            <div>
              {product.productId === selectedProductId ? (
                <div className="container-fluid d-flex justify-content-center pt-5 pb-2">
                  <div
                    className="card rounded-2 border-0 pt-4"
                    style={{ width: "20rem" }}
                  >
                    <img
                      src={
                        BASE_URL + `/api/v1/products/image/${product.imageURL}`
                      }
                  ...
                  <div
                    className="card rounded-0 border-secondary border-0 border-end p-3"
                    style={{ width: "30rem" }}
                  >
                    <p className="fw-normal fs-3 mb-0">{product.productName}</p>
                    <p className="fw-light fs-6 text-secondary mb-0">
                      Product-Id: ECPD{product.productId}
                    </p>
                    <p className="fs-5">
                      {"★★★★★".slice(0, calculateRatings(product.reviews)) +
                        "☆☆☆☆☆".slice(calculateRatings(product.reviews), 5)}
                    </p>
                    <p className="fw-normal fs-6 mb-0">
                      Ratings: {calculateRatings(product.reviews)}
                    </p>
                    <p className="fw-bold fs-2 text-dark mb-0">
                      ₹ {product.price}
                    </p>
                    ...
                    <input
                      ...
                      className="form-control rounded-2 border-0 bg-light shadow-none"
                      style={{ width: "4rem" }}
                    />
                    <p className="fw-light fs-6 text-success mb-2">
                    ...
                    <label className="fw-normal fs-6 text-secondary mb-0">
                      {product.productDesc}
                    </label>
                  </div>

                  <div
                    className="card rounded-2 border-0 p-3 ms-5"
                    style={{ width: "20rem" }}
                  >
                    <div
                      class="modal fade"
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p
                              id="rating-sense"
                              className="text-center fs-4 fw-light ms-3"
                            >
                              Rate this product
                            </p>
                            <textarea
                          ...
                          <div class="modal-footer">
                            ...
                            <button
                              ...
                              data-bs-dismiss="modal"
                              onClick={() =>
                                handleAddReview(product.productId, userInfo)
                              }
                            >
                              Post review
                            </button>
                    ...
                    <p className="fw-normal fs-3 mx-auto">Customer Reviews</p>
                    <div
                    ...
                    >
                      <div>
                        {product.reviews.length > 0 ? (
                          product.reviews.map((review) => (
                            <div>
                              <div className="d-flex">
                                <span className="badge bg-warning me-2 fs-6 fw-light rounded-circle py-2">
                              ...
                              <div className="d-flex justify-content-between">
                                <p className="fs-5 mb-0">
                                  {"★★★★★".slice(0, review.rating) +
                                    "☆☆☆☆☆".slice(review.rating, 5)}
                                </p>
                                {userInfo !== null &&
                                review.user.email === userInfo.username ? (
                                  <Link
                                    className="link-danger fs-6 fw-bold text-decoration-none p-1"
                                    onClick={() =>
                          ...
                          <p className="text-center text-secondary fs-5 fw-light">
                            No reviews yet
                          </p>
                        )}
                      </div>
