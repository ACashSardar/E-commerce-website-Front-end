...
const Cart = ({ cartItems, setCartItems, loadCartitems, loadOrders }) => {
  ...
  const handleUpdateCartItem = (cartItemId, change, userInfo) => {
    ...
    if (
      currItem.quantity + change >= 1 &&
      currItem.quantity + change <= currItem.product.stock
    ) {
    ...
    <div className="bg-canvas p-5">
      {cartItems.length > 0 ? (
        <div className="row">
          <div className="col-md-8 col-sm-12 p-2">
            {cartItems.map((cartItem, index) => (
              <div className="shadow bg-light rounded-1 d-flex p-2 mb-2">
                <img
                  className="rounded-1"
                  src={`http://localhost:8080/api/v1/products/image/${cartItem.product.imageURL}`}
                  alt=""
                ...
                <div className="p-2 px-4" style={{ width: "100%" }}>
                  ...
                  <div className="d-flex justify-content-between">
                    <span className="me-2">
                      ...
                      <span className="fw-bold rounded-1 p-2 px-2">
                        {cartItem.quantity}
                      </span>
                      <button
                        className="btn btn-sm btn-dark border fw-bold"
                    ...
                    <button
                      ...
                      onClick={() => {
                        handleDeletingCartItem(cartItem.cartItemId, userInfo);
                      }}
                    >
                      Remove
                    </button>
          ...
          <div
            className="col-md-4 col-sm-12 shadow bg-light rounded-1 p-4 mt-2 mb-3"
          ...
          >
            ...
            <div className="mb-4">
              ...
              <div className="d-flex">
                ...
                />
                <img
                  src="https://1000logos.net/wp-content/uploads/2017/03/Color-MasterCard-Logo.jpg"
                  alt=""
                  style={{ height: "2rem", width: "3rem" }}
                  className="border me-2"
                />
                <img
                  src="https://bsmedia.business-standard.com/_media/bs/img/article/2015-01/19/full/1421664764-4083.jpg?im=FeatureCrop,size=(826,465)"
                  alt=""
                  style={{ height: "2rem", width: "3rem" }}
                  className="border me-2"
                />
                <img
                  src="https://st4.depositphotos.com/5225467/22068/v/450/depositphotos_220680152-stock-illustration-paypal-logo-printed-white-paper.jpg"
                  alt=""
                  style={{ height: "2rem", width: "3rem" }}
                  className="border me-2"
                />
            ...
            <div className="fs-6 d-flex justify-content-between">
              ...
              >
                <button
                  ...
                  onClick={() => handleAddOrder(userInfo)}
                >
                  Check out
                </button>
              </Link>
