                    ...
                    <div className="row">
                      <div className="col-md-6">
                        ...
                        {order.deliveryStatus === "✅Delivered" ? (
                          <span className="fs-6 p-2 rounded-1">
                            ✅Order Delivered.
                          </span>
                        ) : (
                          <form
                            className="d-flex"
                            onSubmit={(e) =>
                              handleAssignOrder(order.orderId, e, userInfo)
                            }
                          >
                            <select
                              className="form-select rounded-2 me-1"
                              name="deliveryPerson"
                              id=""
                              style={{ width: "13rem" }}
                            >
                            ...
                            <button className="custom-btn1 rounded-2">
                              Save
                            </button>
                          </form>
                        )}
                          ...
                          {order.orderItems.map((orderItem, index) => (
                            <li>
                              <span className="d-flex">
                                <h6 className="text-secondary fw-bold me-2">
